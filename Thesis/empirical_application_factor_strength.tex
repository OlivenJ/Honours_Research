\chapter{Empirical Application of Factor Strength}\label{Empirical:factor_strength}
...
Here $x_{it}$ is the excess return of asset i at time t, which is pre-defined in chapter \ref{data}.
