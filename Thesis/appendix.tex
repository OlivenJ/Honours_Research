...
\begin{table}[!hbt]
		\caption{Simulation result for experiment 1}\label{exp1_table}
	\centering
...
In this experiment, we have standard normal errors and factors. Factor loadings come form uniform distribution $IIDU(\mu_{\beta} - 0.2, \mu_{\beta}+0.2)$. $[n^{\alpha_{j}}]$
\end{table}


\begin{table}[!hbt]
		\caption{Simulation result for experiment 2}\label{exp2_table}
	\centering
	\begin{tabular}{lccccccccc}
		\hline
		\hline
...
\end{table}
	...
	\begin{table}[]
		\caption{Simulation result for experiment 3}\label{exp3_table}
		\centering
	\begin{tabular}{lccccccccc}
		\hline
		\hline
