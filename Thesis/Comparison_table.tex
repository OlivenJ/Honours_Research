...
\begin{landscape}
			\chapter{Empirical Application Result}
			\section{Factor Strength Estimation Table}\label{strength_table}
\begin{footnotesize}
...
\begin{landscape}
	\begin{figure}[ht]
		\centering
		\caption{Thirty Year Decompose Comparison}
