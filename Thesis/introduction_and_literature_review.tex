...
Researches (see \citeNP{Fama1992, Carhart1997, Kelly2019}) have shown that adding different risk factors into the CAPM model can enhance the ability of pricing the idiosyncratic risk.
