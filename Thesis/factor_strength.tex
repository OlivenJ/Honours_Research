...
\[ t_{i j T}=\frac{\left(\mathbf{f}_{j t}^{\prime} \mathbf{M}_{F_{-j}} \mathbf{f}_{j t}\right)^{-1 / 2}\left(\mathbf{f}_{j t}^{\prime} \mathbf{M}_{F_{-j}} \mathbf{x}_{i}\right)}{\hat{\sigma}_{i T}} \]

Here, $\mathbf{f}_{j t}=\left(f_{j 1}, f_{j 2}, \ldots, f_{j T}\right)^{\prime}, \mathbf{x}_{i}=\left(x_{i 1}, x_{i 2}, \ldots, x_{i T}\right)^{\prime}, \mathbf{M}_{F_{-j}}=\mathbf{I}-\mathbf{F}_{-j}\left(\mathbf{F}_{-j}^{\prime} \mathbf{F}_{-j}\right)^{-1} \mathbf{F}_{-j}^{\prime}$, and $\mathbf{F}_{-j}=\left(\mathbf{f}_{1 t}, \ldots, \mathbf{f}_{j-1 t}, \mathbf{f}_{j+1 t}, \ldots, \mathbf{f}_{m t}\right)^{\prime}$
