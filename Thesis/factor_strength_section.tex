...
In a latter paper, \citeA{Bailey2016} extended the method by loosen some restrictions, and proved that their estimation can also be applied on the residuals or regression result.
